...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card border-dark">
            <div class="card">
                <div class="card-header bg-primary text-whaite border-dark"><strong>UPDATE DATA PENDAFTARAN</strong></div>
                <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="ipk" value="<?php echo $row["ipk"] ?>" value="0.00" step="0.01" min="1" max="4" required>
                </div>
                <div class="form-group">
