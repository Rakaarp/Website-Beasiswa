...
<nav class="navbar navbar-dark bg-primary border navbar-expand-sm fixed-top">
    ...
    <ul class="navbar-nav">
        ...
        ?>
            <li class="nav-item active"><a class="nav-link" href="?page=mahasiswa"><i class="fas fa-graduation-cap"></i> Mahasiswa </a></li>
            <li class="nav-item active"><a class="nav-link" href="?page=pendaftaran"><i class="fas fa-handshake"></i> Pendaftaran </a></li>
            <li class="nav-item active"><a class="nav-link" href="?page=perangkingan&thn="><i class="fas fa-award"></i> Perangkingan </a></li>
            <li class="nav-item active"><a class="nav-link" href="?page=report"><i class="fas fa-print"></i> Report </a></li>
        <?php
            }
